  ...
  <About>
    ...
    <AboutText>
      ...
      <p>
        ...
        and NoSQL databases, Firebase, React, HTML, and CSS. I also have some
        experience with AWS (Lambda), Java, Rust, and robotics hardware from
        independent projects. I thrive in environments that constantly push me
        to learn and want to learn more programming languages, including Swift
        and Go. For more of my experience, check out my work below!
      </p>
      <p>
        When I'm not on the job, I love to venture outdoors either via biking,
        kayaking, or hiking, taking photos while traveling, catching a game of
        soccer, or strumming my bass guitar.
      </p>
    </AboutText>
